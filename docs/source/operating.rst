[NewProject2-00f8] Operating Details
====================================

Generated On: 2024-11-07 16:00:30 UTC
...
.. important::
   ...
   **not be valid if your [NewProject2-00f8] container is NOT running**.

.. tip::
   You must have your [NewProject2-00f8] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/osayeni/samuel  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=36863  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='osayeni'  \-\-env DOCKERUSERNAME='osayeni'  \-\-env MQTTUSERNAME='osayeni'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   osayeni/NewProject2-00f8-amd64 (https://hub.docker.com/r/osayeni/NewProject2-00f8-amd64)
...
.. important::
   docker run -d -p 49475:49475 -p 53809:53809 -p 44223:44223 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=NewProject2-00f8 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-NewProject2-00f8 \-\-env GITUSERNAME=osayeni  \-\-env GITREPOURL=https://github.com/osayeni/samuel \-\-env SOLUTIONEXTERNALPORT=49475  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=53809  \-\-env SOLUTIONVIPERVIZPORT=44223 \-\-env DOCKERUSERNAME='osayeni' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=36863 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='osayeni' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  osayeni/NewProject2-00f8-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=44223
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=49475
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - osayeni/NewProject2-00f8-amd64
...
It can be accessed by entering: http://localhost:53809
...
.. important::
   http://localhost:44223/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:44223/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:44223/<html file>
...
[NewProject2-00f8] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/osayeni/samuel/tree/main/tml-airflow/dags/tml-solutions/NewProject2-00f8
...
.. important::
   https://NewProject2-00f8.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-NewProject2-00f8
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=49475, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43713, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43841, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46249, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=37379, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=44783, HPDEHOST=127.0.1.1, HPDEPORT=32795, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44827

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5301-NewProject2-00f8,solution_preprocessing_ai_mqtt_dag-NewProject2-00f8, python-preprocess-2138-NewProject2-00f8,solution_preprocessing_ai_mqtt_dag-NewProject2-00f8, python-ai-8046-NewProject2-00f8,solution_preprocessing_ai_mqtt_dag-NewProject2-00f8, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
